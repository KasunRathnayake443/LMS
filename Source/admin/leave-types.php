...
<div class="d-flex">
    ...
    <?php endif; ?>
        ...
        <a class="nav-link active" href="leave-types.php"> Leave Types</a>
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        ...
                        <div class="success2" id="alertBox">
                            ...
                            <span class="message-text">New Leave Type Added successfully.</span>                            
                            <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                        </div>
                        <div class="alert2" id="alertBox2">
                            <i class="fa fa-trash fa-2x"></i> 
                            <span class="message-text">Leave Type Deleted successfully.</span>                            
                            <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                        </div>
